...
from models.layers import LogMelSpectrogramLayer, customCNN2D, customCNN1D, EnvelopeFollowingLayerTorchScript
...
class v1_mi6_env2_mod_new_stack2(nn.Module):
    ...
    def _create_cnn_env_block(self):
        ...
        # augment kernel
        return nn.Sequential(
            customCNN1D(1, 40, 20, "same", 1), 
            nn.AvgPool1d(16),
            nn.Dropout1d(0.25),
            customCNN1D(40, 40, 15, "same", 2), 
            nn.AvgPool1d(8),
            nn.Dropout1d(0.25),
            customCNN1D(40, 80, 7, "same", 3), 
            nn.AvgPool1d(8),
            nn.Dropout1d(0.25),
            customCNN1D(80, 160, 2, "same", 4),
            nn.AvgPool1d(7),
            nn.Dropout1d(0.25),
        )
