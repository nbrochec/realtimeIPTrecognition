...
if __name__ == '__main__':
    ...
    DatasetSplitter.split_train_validation(base_dir=base_dir, destination=csv_dir, train_dir=args.train_dir, test_dir=args.test_dir, val_ratio=args.val_ratio, val_split=args.val_split, name=args.name)
